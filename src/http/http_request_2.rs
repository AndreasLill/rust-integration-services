...
impl HttpRequest2 {
    ...
    pub fn from_parts(body: BoxBody<Bytes, Error>, parts: hyper::http::request::Parts) -> HttpRequest2 {
        HttpRequest2 {
            body,
            parts
        }
...
impl HttpRequestBuilder {
    ...
    pub fn build(self) -> HttpRequest2 {
        ...
        HttpRequest2::from(request)
    }
}

impl From<HttpRequest2> for Request<BoxBody<Bytes, Error>> {
    fn from(req: HttpRequest2) -> Self {
        Request::from_parts(req.parts, req.body.boxed())
    }
}

impl From<Request<BoxBody<Bytes, Error>>> for HttpRequest2 {
    fn from(req: Request<BoxBody<Bytes, Error>>) -> Self {
        let (parts, body) = req.into_parts();
        HttpRequest2::from_parts(body, parts)
    }
}

impl From<Request<Incoming>> for HttpRequest2 {
    fn from(req: Request<Incoming>) -> Self {
        let (parts, body) = req.into_parts();
        HttpRequest2::from_parts(body.boxed(), parts)
    }
}
